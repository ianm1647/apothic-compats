...
import ianm1647.apothic_compats.affix.aetherii.MagicalDartAffix;
...
public class ModAffixRegistry {
    ...
    public static void registerAffixes() {
        if (ModList.get().isLoaded("aetherii")) {
            AffixRegistry.SERIALIZER.register(ApothicCompats.loc("magical_dart"), MagicalDartAffix.CODEC);
        }
