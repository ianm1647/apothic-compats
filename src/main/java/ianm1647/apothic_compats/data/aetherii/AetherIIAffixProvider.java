package ianm1647.apothic_compats.data.aetherii;
...
public class AetherIIAffixProvider extends AffixProvider {
    String mod = "aetherii";

    public AetherIIAffixProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries);
    }

    @Override
    public String getName() {
        return "Aether II Affixes";
    }
