...
public class TwilightAffixProvider extends AffixProvider {
    String mod = "twilightforest";

    public TwilightAffixProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries);
    }

    @Override
    public String getName() {
        return "Twilight Forest Affixes";
    }
